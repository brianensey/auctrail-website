...
export const metadata: Metadata = {
  title: { absolute: "Surplus Asset Disposition Software | Auctrail" },
  description: "Auctrail is surplus asset disposition software that connects intake, review, sale preparation, payment, pickup, and completed history in one organized workflow.",
  alternates: { canonical: "/" },
  openGraph: { url: "/", title: "Surplus Asset Disposition Software | Auctrail", images: [{ url: "/auctrail-logo-mark.png", width: 512, height: 512, alt: "Auctrail" }] },
};
...
const structuredData = [
  {
    ...
    "@type": "Organization",
    name: "Auctrail",
    url: "https://www.auctrail.com/",
    logo: "https://www.auctrail.com/auctrail-logo-mark.png",
    description: "Surplus asset disposition management software for public agencies, businesses, nonprofits, and institutions.",
    contactPoint: {
      "@type": "ContactPoint",
      contactType: "product information",
      email: "info@auctrail.com",
      url: "https://www.auctrail.com/contact/",
    },
  },
  {
    "@context": "https://schema.org",
    ...
    <main className="new-site editorial-site">
        ...
        <section className="editorial-hero">
          <div className="site-shell hero-editorial-grid">
            ...
            <div className="hero-editorial-copy">
              <p className="signal"><span /> Surplus asset disposition software</p>
      ...
      <section className="manifesto">
        <div className="site-shell manifesto-grid">
          ...
          <div>
            ...
            <p>Auctrail replaces disconnected surplus-property spreadsheets, inboxes, and shared drives with a common record, a visible next step, and a disposition history that stays intact.</p>
          </div>
        </div>
      </section>
      ...
      <section className="trail-section">
        <div className="site-shell trail-grid" id="auction-workflow">
          <div className="trail-intro">
            ...
            <p>Follow the complete surplus auction workflow without building a second process around the software.</p>
          </div>
      ...
      <section className="product-band web-band">
        <div className="site-shell band-grid">
          ...
          <div className="offset-screen"><Image src="/product-screenshots/cases.png" alt="Auctrail surplus property cases and workflow" width={560} height={350} /></div>
        </div>
      </section>
