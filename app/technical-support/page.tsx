...
const supportAreas = [
  ...
  ["03", "Labels and QR workflows", "Troubleshoot supported label-printing and QR-based record-access workflows used by agency staff."],
  ["04", "Exports and integrations", "Get assistance with Auctrail sales-channel exports, including GovDeals-compatible bulk-upload files when the agency account is enabled for that capability."],
