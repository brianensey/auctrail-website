...
export const metadata: Metadata = {
  ...
  description: "Auctrail is in active development. Learn about pricing availability, what to expect at launch, and how to ask about the surplus asset disposition platform.",
