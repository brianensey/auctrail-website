...
export default function PlansPage() {
  ...
  return <main className={`marketing-site ${styles.plansSite}`}><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(pricingJsonLd) }} /><MarketingHeader />
    ...
    <section className="final-cta"><div className="marketing-shell final-cta-inner"><div><p className="section-kicker light">A plan matched to agency needs</p><h2>Choose the core platform or add management automation.</h2><p>Start with the way your agency operates today, then decide whether advanced automation, reporting, customization, and assisted service justify Professional.</p></div><div className="final-cta-actions"><Link className="button button-light" href="/demo">Request Demo <ArrowIcon /></Link><a className="button button-dark-outline" href="https://app.auctrail.com/login">Client login</a></div></div></section><SiteFooter /></main>;
}
