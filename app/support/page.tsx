...
export default function SupportPage() {
  ...
  <section className="support-main"><div className="marketing-shell"><div className="support-intro"><p className="section-kicker">Client support and access</p><h1>Help for agencies already using Auctrail.</h1><p>Access your agency workspace, get technical assistance, or find documentation for the Auctrail surplus-sales platform.</p></div><div className="support-card-grid">
  <article className="support-card-new"><span>01</span><h2>Client access</h2><p>Sign in to your agency workspace to manage surplus-sale records, departments, reports, auction preparation, and completed sale history.</p><a className="button button-primary" href="https://app.auctrail.com/login">Open client login <ArrowIcon /></a></article>
