...
export default function SupportPage() {
  ...
  <article className="support-card-new"><span>03</span><h2>Documentation and FAQ</h2><p>Review common questions about surplus-sale workflows, exports, labels, QR access, hosting, development status, and supported features.</p><Link className="button button-secondary" href="/faq">View FAQ <ArrowIcon /></Link></article></div>
  <RealAppShot src="/screenshots/dashboard.svg" alt="Current Auctrail dashboard" caption="Current Auctrail dashboard and work overview" />
