...
export default function OrganizationSetupPage() {
  return <main className={`marketing-site ${styles.site}`}><MarketingHeader />
    ...
    <section className={styles.section}><div className="marketing-shell"><div className={styles.heading}><div><p className="section-kicker">Organization controls</p><h2>Configure the experience and the operating rules in one place.</h2></div><p>Authorized administrators can set the organization’s visual identity and define the pickup deadline used to flag overdue sold property.</p></div><RealAppShot src="/screenshots/branding.svg" alt="Current Auctrail Branding screen" caption="Organization branding, color scheme, and icon settings" /><RealAppShot src="/screenshots/pickup-deadline.svg" alt="Current Auctrail Pickup Deadline screen" caption="Organization-wide sold-item pickup deadline configuration" /></div></section>
