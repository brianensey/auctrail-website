...
export const metadata: Metadata = {
  ...
  description: "Answers to common questions about Auctrail surplus asset disposition software, supported industries, pricing, organization setup, GovDeals exports, storage, support, labels, QR codes, and completed sale records.",
...
export default function FAQPage(){
 ...
 <section className={styles.hero}><div className={`marketing-shell ${styles.heroInner}`}><p className="section-kicker">Frequently asked questions</p><h1>Common questions about Auctrail, answered clearly.</h1><p>Supported industries, surplus asset disposition, pricing, storage, GovDeals exports, records, labels, QR codes, organization setup, hosting, and support—all in one place.</p><div className={styles.heroActions}><Link className="button button-primary" href="/plans">View plans <Arrow/></Link><Link className="button button-secondary" href="/support">Support center <Arrow/></Link></div></div></section>
