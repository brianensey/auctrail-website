...
export const metadata: Metadata = {
  title: "Surplus Asset Disposition Software FAQs",
  description: "Answers about Auctrail, surplus asset disposition workflows, product development, photos, documents, QR labels, iPad use, pricing, demos, and auction-site integrations.",
  alternates: { canonical: "/faq/" },
  openGraph: { url: "/faq/", title: "Surplus Asset Disposition Software FAQs | Auctrail", images: [{ url: "/auctrail-logo-mark.png", width: 512, height: 512, alt: "Auctrail" }] },
};
...
const questions = [
  ...
  ["How is Auctrail different from general asset management software?", "General asset management systems focus on property while it is in service. Auctrail focuses on the controlled process for property that is ready to be reviewed, prepared, sold, transferred, documented, and closed out."],
  ["What parts of a surplus sale can Auctrail track?", "Auctrail connects intake, review, listing preparation, supporting files, results, payment, pickup, and completed history in one case record."],
  ...
  ["Does Auctrail preserve a completed disposition history?", "Yes. Completed records retain the information and supporting documentation associated with the disposition instead of leaving the history scattered across separate files and inboxes."],
