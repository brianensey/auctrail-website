...
export const metadata: Metadata = {
  ...
  description: "Answers to common questions about Auctrail surplus asset disposition software, pricing, organization setup, GovDeals exports, storage, security, support, labels, QR codes, and completed sale records.",
  keywords: ["Auctrail FAQ", "surplus asset disposition software FAQ", "surplus sales management software", "GovDeals export software", "government surplus sales software"],
...
const sections = [
  { title: "About Auctrail", items: [
    ...
    ["Who is Auctrail designed for?", "Auctrail is designed for organizations across industries that are responsible for preparing and selling surplus property, including public agencies, businesses, nonprofits, and other organizations."],
  ...
  { title: "Plans and pricing", items: [
    ["How much does Auctrail cost?", "Auctrail offers Essential and Professional plans. Current monthly prices and annual totals are published on the Plans and Pricing page."],
    ["What is the difference between Essential and Professional?", "Both include the complete Auctrail surplus-sales workflow and unlimited surplus-sale records. Essential includes up to 5 active users and 5 departments or teams with guided setup. Professional includes up to 20 active users, unlimited departments or teams, assisted onboarding, initial data-import assistance, and priority email support."],
    ["Are important features removed from Essential?", "No. Essential still includes the core surplus intake-to-sale-closeout workflow, photos and documents, permissions and audit history, auction preparation, GovDeals-compatible export, labels, QR access, reporting, exports, hosting, updates, and normal-use storage."],
  ...
  { title: "Storage, records, and data", items: [
    ...
    ["Are surplus-sale records limited?", "No. Essential and Professional both include unlimited surplus-sale records. Plan limits apply primarily to active users and, for Essential, the number of departments or teams."],
    ...
    ["Can existing data be imported?", "Yes, depending on the source and condition of the data. Essential includes import templates. Professional includes initial data-import assistance. Existing surplus-sale spreadsheets or records should be reviewed during organization setup."],
  ]},
  ...
  { title: "Labels, QR codes, and devices", items: [
    ...
    ["Does Auctrail provide printers or tablets?", "Not as part of the standard software subscription. Organizations can use compatible hardware, and Auctrail documentation can identify supported or recommended workflows as they are validated."],
  ]},
  { title: "Organization setup and users", items: [
    ...
    ["Can different departments or teams use the same Auctrail account?", "Yes. Auctrail is structured for organization-wide use across departments or teams. Essential supports up to 5, while Professional includes unlimited departments or teams."],
    ...
    ["Can we upgrade from Essential to Professional later?", "Yes. An organization can move to Professional as its staff, department, team, or location needs grow without rebuilding its Auctrail surplus-sale records."],
  ]},
...
export default function FAQPage(){
 ...
 <section className={styles.hero}><div className={`marketing-shell ${styles.heroInner}`}><p className="section-kicker">Frequently asked questions</p><h1>Common questions about Auctrail, answered clearly.</h1><p>Surplus asset disposition, pricing, storage, GovDeals exports, records, labels, QR codes, organization setup, hosting, and support—all in one place.</p><div className={styles.heroActions}><Link className="button button-primary" href="/plans">View plans <Arrow/></Link><Link className="button button-secondary" href="/support">Support center <Arrow/></Link></div></div></section>
